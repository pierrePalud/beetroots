...
#                 Theta_0, _ = self.read_MLE_from_csv_file(model_name)
#                 Theta_0 = self.scaler.from_lin_to_scaled(Theta_0)
#                 # Theta_0 += psgld_params.sigma_mtm * sampler.rng.normal(size=Theta_0.shape)
...
#                 v0 = v0.flatten()
#                 Theta_0 = self.scaler.from_lin_to_scaled(Theta_MAP_lin)
